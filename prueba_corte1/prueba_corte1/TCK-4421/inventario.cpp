...
public:
    ...
    // FALTA ALGO AQUI
    // Se elimina el -1 del if(i >=0 && i < n-1) para que tome el ultimo elemento del arreglo
...
int main() {
    ...
    // Se liberan todas las fugas de memoria, primero arreglo totales, luego cada objeto equipoy finalmente el arreglo de punteros a equipos
    delete[] totales;
    delete equipos[0]; delete equipos[1]; delete equipos[2];
    delete[] equipos;
